...
pre_baichuan_results_new = filtered_outputs_new
...
pre_baichuan_results = filtered_outputs

print('Pre-Edit Outputs: ', pre_baichuan_results_new)

print('Old Pre-Edit Outputs: ', pre_baichuan_results)

with open('shared_baichuan_pre.py', 'w') as shared_file:
    shared_file.write(f"pre_baichuan_results_new = {pre_baichuan_results_new}")

with open('shared_baichuan_old_pre.py', 'w') as shared_file:
    shared_file.write(f"pre_baichuan_results = {pre_baichuan_results}")
