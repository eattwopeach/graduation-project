...
pre_llama_results_new = filtered_outputs_new
...
pre_llama_results = filtered_outputs

print('Pre-Edit Outputs: ', pre_llama_results_new)

print('Old Pre-Edit Outputs: ', pre_llama_results)

with open('shared_llama_pre.py', 'w') as shared_file:
    shared_file.write(f"pre_llama_results_new = {pre_llama_results_new}")

with open('shared_llama_old_pre.py', 'w') as shared_file:
    shared_file.write(f"pre_llama_results = {pre_llama_results}")
